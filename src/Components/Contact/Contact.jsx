  ...
  return (
    <div className='contact-bg pt-3 '>
      ...
      <div className='row justify-content-center align-items-center py-3 text-center'>
        ...
        <div  className='col-md-1 px-md-1'><a href="صناعة و تجارة" className=' text-decoration-none text-black fw-bolder'>صناعة و تجارة</a></div>
        <div  className='col-md-1'><a href="عقارات" className=' text-decoration-none text-black fw-bolder'>عقارات</a></div>
        <div  className='col-md-1'><a href="مالتي ميديا" className=' text-decoration-none text-black fw-bolder'>مالتي ميديا</a></div>
